...
class WeeklyPerfomanceReviewForm(ModelForm):
    ...
    class Meta:
        ...
        fields = ['evaluation', 'innovations', 'activity1', 'activity2', 'activity3', 'activity4', 'activity5', 'activity6', 'activity7', 'work_to_be_done1', 'work_to_be_done2', 'work_to_be_done3', 'work_to_be_done4', 'work_to_be_done5', 'work_to_be_done6', 'work_to_be_done7', 'work_done1', 'week_starting', 'week_ending', 'supervisors', 'work_done1', 'work_done2', 'work_done3', 'work_done4', 'work_done5', 'evidence_of_work_done1' , 'evidence_of_work_done2' , 'evidence_of_work_done3' , 'evidence_of_work_done4' , 'evidence_of_work_done5' ]
        labels = {
